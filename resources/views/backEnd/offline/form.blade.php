                            ...
                            <div class="col-md-12 col-sm-12 mt-2">
                                <form action="{{ route('events.cekKupon', $batch->id) }}" method="POST">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            class="form-control {{ ($kupon_digunakan == 1) ? 'disabled' : '' }}"
                                ...
                                <form action="{{ route('events.purchase', $batch->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="nik" name="nik"
                                            placeholder="Customer NIK" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="phone" name="phone"
                                            placeholder="Start with 62, Ex: 6281xxxx" required>
                                    </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 font-weight-bold"><span id="price"
                                                            ...
                                                            <del
                                                                class="text-muted">{{ number_format($batch->price, 0, '', '.') }}</del>
                                                            {{ number_format($batch->price - $batch->kupon->value, 0, '', '.') }}</span>
                                                    </div>
                                                    @else
                                                    <div class="col-6 font-weight-bold"><span id="price"
